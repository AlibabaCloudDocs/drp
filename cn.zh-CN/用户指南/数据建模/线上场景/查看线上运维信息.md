...
您已经部署运行线上场景，详细请参见[上线场景部署并运行](/cn.zh-CN/用户指南/数据建模/线上场景/上线场景部署并运行.md)。
...
6.  单击离线服务任务左侧的**![1](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/5429170261/p272554.png)图标**，查看节点列表。单击**某个节点名称**，进入任务列表页面。
...
6.  单击离线服务任务左侧的**![1](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/5429170261/p272554.png)图标**，查看节点列表。单击**某个节点名称**，进入任务列表页面，查看实例内容、服务接口和实例列表。
